...
const currentStageId = 'stage3'
const currentStagePath = '/stage3'
const previousStagePath = '/stage2'
const nextStagePath = '/stage4'

const stageAriaLabel = '節點三 反應爐水池介紹'
const stageKicker = '力量的痕跡'
const stageTitle = '- 反應爐水池 -'

const componentRewardTitle = '獲得了組件【冷卻水池】'
 ...
 */
const componentRewardBgUrl = '/images/stage3/stage3-component-reward.png'
...
.knowledge-section {
  ...
  background:
    ...
    url("/images/stage3/stage3-knowledge-bg.png");

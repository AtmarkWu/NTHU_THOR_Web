...
const stageTitle = '- BNCT治療室 -'

const componentRewardTitle = '獲得了組件【BNCT專用儀器組】'
 ...
 */
const youtubeVideoId = '2CzH-iiGfgI'
const youtubePlayerElementId = 'stage4-youtube-player'

/**
 * 看完影片後「獲得組件」彈窗背景圖。
 * 請放在 public/images/stage1/stage1-component-reward.png
 */
const componentRewardBgUrl = '/images/stage4/stage4-component-reward.png'
...
const knowledgePoints = [
  {
    ...
    title: '騙敵深入的標靶藥物',
    body:
      '癌細胞為了快速分裂，需要吸收大量的氨基酸。這時將「硼-10」包裝在氨基酸衍生物 (BPA) 中，就會讓癌細胞誤以為是美食而瘋狂吞食。在標靶藥物注射後，腫瘤內部的硼濃度會遠高於周圍正常組織，讓癌細胞在無形中與正常細胞劃清界線。',
  },
  {
    id: 'point2',
    buttonText: '核反應的危險性',
    title: 'BNCT是做細胞內的精準引爆',
    body:
      '當清大反應爐的「超熱中子束」照射患部，中子遇到癌細胞體內的硼-10，會發生中子捕獲反應。該反應會釋放出阿爾法粒子與鋰離子。這兩種粒子的飛行距離極短 (僅 5 到 8 微米)，剛好就是一個細胞的直徑！能量在癌細胞內部完全釋放、切斷其 DNA，做到真正的「定點清除」。',
  },
  {
    id: 'point3',
    buttonText: 'BNCT有多安全可靠',
    title: '嚴謹的醫療監測與安全把關',
    body:
      '治療前會透過 PET (正子斷層掃描) 嚴密監測病人體內的藥物代謝，精準計算出中子束需要照射的時間。與傳統放療相比，傳統放療需要分幾十次、耗時數週；而 BNCT 效率極高，通常只需要 1 到 2 次的照射（每次約 20-30 分鐘）即可完成療程。',
  },
]
  ...
  <main class="stage-page" :style="pageStyle">
    ...
    >
      ...
      <div class="intro-text">
        <p>
          如果說傳統放療是拿散彈槍對著腫瘤區域掃射，那 BNCT 就是精準潛入癌細胞內部的「細胞級原子彈」。它的運作只靠 3 個主角：
        </p>
        <p>
          1. 標靶硼藥：偽裝成營養素的特製藥物。癌細胞因為太貪吃會瘋狂吞下它，形同在身上裝了「定位導航」。
        </p>
        <p>
          2. 醫療中子束：由清大反應爐產生的特殊粒子束，平常對人體無害，是引爆核反應的「導火線」。
        </p>
        <p>
          3. 微型核反應：當中子撞擊到癌細胞內的硼，會瞬間在細胞內部引爆。爆炸範圍只有一個細胞大，剛好炸毀癌細胞，卻不傷及隔壁的正常細胞。
        </p>
      </div>
...
.knowledge-section {
  ...
  background:
    ...
    url("/images/stage4/stage4-knowledge-bg.png");
